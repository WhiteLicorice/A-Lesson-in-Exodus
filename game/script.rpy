...
label start:
    # play music "" fadein 1.0 volume 
    # queue " "
    # play sound "" # soundfx
    
    scene asset_bg_entrance with dissolve
    ...
    menu:
        "Classical and Model-Dependent":
            ...
            # show sen_sei_smiling at truecenter
            show c1 at left :
                xzoom 2 yzoom 2
                align((-0.7, 1.0))
            S "That's correct!"
...
label topic_1:
    ...
    "Classical and model-dependent realism?"
    stop sound
    ...
    "That must mean that there's a singular truth. A true description of reality."
    stop sound
    ...
    scene asset_background_classroom with dissolve

    play sound "audio/narrator_VO/Narrator4.mp3"
    "Sen Sei paces around the board."
    stop sound
    ...
    "It means that reality depends on multiple models?"
    stop sound
    ...
    S "Sen Sei stops and takes out a tablet."
    stop sound
    ...
    "An innocent sentence flashes on the board."
    stop sound
...
label topic_2:
    ...
    # LOAD EDWIN HUBBLE
    scene edwin_hubble with dissolve

    play sound "audio/narrator_VO/Narrator10.mp3"
    "Edwin Hubble. A 20th century American scientist who played a crucial role in establishing extragalctic astronomy and observational cosmology."
    stop sound
    ...
    "How strange that his fiction of yesterday is the reality of tomorrow."
    stop sound
...
label quiz2_q1:
    ...
    "The Andromeda galaxy. Our nearest galactical neighbor."
    stop sound
    ...
    "The Doppler Effect applied to light, aptly named redshift. Light from a distance appears displaced towards the red end of the spectrum."
    stop sound
...
label quiz2_q2:
    ...
    "A single innocuous question appears on the board."
    stop sound
...
label topic_3:
    ...
    # LOAD BIGBANG ASSET
    scene asset_bigbang with dissolve
...
label quiz2_q4:
    ...
    S "The universe contineud to expand and cool, and electrons combined with atomic nuclei to form neutral atoms, 380,000 years after the Big Bang. This process was called..."
    stop sound
...
label quiz2_q5:
    ...
    S "It's called recombination. After neutral atoms were formed through recombination, the universe still continued to expand and cool. Stars and galaxies formed from the graviational colapse of clouds of dust and gas. "
    stop sound
...
label topic_4:
    ...
    # LOAD ASSET STAR1
    scene asset_star_one with dissolve
    ...
    # LOAD ASSET STAR2
    scene asset_star_two with dissolve
    ...
    # LOAD ASSET STAR3
    scene asset_star_three with dissolve
    ...
    # LOAD ASSET STAR4
    scene asset_star_four with dissolve
    ...
    # LOAD ASSET STAR5
    scene asset_star_five with dissolve
    ...
    # LOAD ASSET STAR6
    scene asset_star_six with dissolve
    ...
    # LOAD ASSET STAR7
    scene asset_star_seven with dissolve
    ...
    # LOAD ASSET STAR8
    scene asset_star_eight with dissolve
